      ...
      <v-row>
        <v-col cols="12" sm="6" md="4">
          ...
          <ul>
            ...
            <li>La Miche Blanche Double <small>(farine blanche)</small> : 8.10 $</li>
          </ul>
        </v-col>
        ...
        <v-col cols="12" sm="6" md="4">
          ...
          <h4><u>Mercredi :</u></h4>
          <ul>
            <li>Le Khorasan <small>(farine de blé tamisée, farine de khorasan)</small> : 5.85 $</li>
            <li>Le Datte choco <small>(farine de blé tamisée, dattes séchées, pépites de chocolat)</small> : 7.20 $</li>
          </ul>
        ...
        <v-col cols="12" sm="6" md="4">
          <h4><u>Vendredi :</u></h4>
          <ul>
            <li>Le Jeremy <small>(farine de blé tamisée, banane fraiche, pépites de chocolat)</small> : 7.20 $</li>
            <li>Le Noix <small>(farine de blé tamisée, noix de Grenoble)</small> : 6.90 $</li>
          </ul>
      ...
      <v-row>
        <v-col cols="12" sm="6" md="4">
          ...
          <ul>
            ...
            <li>Le Pois Chiche <small>(farine de blé tamisée, farine de pois chiche)</small> : 7.20 $</li>
            <li>Le Quinoa <small>(farine de blé tamisée, farine de quinoa)</small> : 7.20 $</li>
          ...
          <i>Pour une commande des pains suivants, s'ils le sont un autre jour que leur jour de production régulier ou
            ...
            Pois
            Chiche, le Quinoa, le Maïs, le Sarrasin et La Miche Rustique.</i>
        </v-col>

        <v-col cols="12" sm="6" md="4">
          <h4><u>Les à côtés sur commande :</u></h4>
          <ul>
            <li>Une pâte à pizza : 3.75 $</li>
          ...
          <ul>
            <li>La douzaine de Gougères <small>(pâte à choux et cheddar vieilli)</small> : 12.50 $</li>
          </ul>
          <ul>
            <li>
              La Fougasse <small>(pâte à pain à la levure et différentes garnitures)</small> : 5.65 $
              <ul>

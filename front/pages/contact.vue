<template>
  <v-layout class="contact" column justify-center align-center>
    <v-flex xs12 sm8 md6>
      <h2>Contact</h2>
      <v-row>
        ...
        <v-col cols="12" sm="8" md="6">
         ...
         Veuillez noter que la boulangerie sera ouverte aux <b>horaires habituels du mardi au jeudi</b>,<br/>
